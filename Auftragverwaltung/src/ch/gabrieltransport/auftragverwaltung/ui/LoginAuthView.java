...
import ch.gabrieltransport.auftragverwaltung.business.GabrielAuthorization;
...
public class LoginAuthView extends XdevView implements com.xdev.security.authentication.ui.LoginView {
	...
	private void cmdLogin_buttonClick(Button.ClickEvent event) {
		try {
			...
			GabrielAuthorization authorizationConfigurationProvider = GabrielAuthorization.getInstance();
